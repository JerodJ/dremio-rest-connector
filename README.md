...
3. Download and install the [REST JDBC Driver from CData](https://www.cdata.com/drivers/rest/download/jdbc)* and copy the JAR file to the /jars/3rdparty/ directory of your Dremio installation. For example:
