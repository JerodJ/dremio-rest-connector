...
@SourceType(value = "RESTARP", label = "REST",uiConfig = "rest-layout.json")
public class RESTConf extends AbstractArpConf<RESTConf> {
  private static final String ARP_FILENAME = "arp/implementation/rest-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.rest.RESTDriver";
